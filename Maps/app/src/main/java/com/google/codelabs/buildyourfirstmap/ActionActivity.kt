    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button_save.setOnClickListener {
            ...
            if(isEmpty(text_name) || isEmpty(text_description)){
                ...
                db.addDataAlert(getString(text_name), getString(text_description), image, position!!.toInt());
                Toast.makeText(this@ActionActivity, "Alerta criado com sucesso", Toast.LENGTH_SHORT).show()
                finish();
            }
        }
